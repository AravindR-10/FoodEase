...
import com.ey.fda.service.PaymentService;
...
public class CustomerController {
	...
	public ResponseEntity<PaymentDTO> makePayment(@RequestBody PaymentDTO paymentDTO) {
		PaymentDTO processed = paymentService.makePayment(paymentDTO);
	...
	public ResponseEntity<DeliveryDTO> getDeliveryStatus(@PathVariable Long orderId) {
